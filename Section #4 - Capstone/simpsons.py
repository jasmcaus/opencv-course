...
x_train, x_val, y_train, y_val = caer.train_test_split(featureSet, labels, val_ratio=0.2)
...
test_path = (
    "../input/the-simpsons-characters-dataset/kaggle_simpson_testset/"
    "kaggle_simpson_testset/charles_montgomery_burns_0.jpg"
)
